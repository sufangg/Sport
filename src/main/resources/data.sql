...
VALUES('S001', 'Ali Rahman', 'ali@example.com', '123 Jalan Mawar', '0123456789', 'pass123'),
...
VALUES('SP01', 'Badminton'),
      ('SP02', 'Basketball');

-- Insert sport_session (requires sport_id and teacher_id that exist)
...
-- Insert into registration (references student_id and session_id)
INSERT INTO registration (student_id, session_id, semester, registration_date)
VALUES('S001', 'SS001', 'SEM 1', '2025-05-30'),
